...
public class SkillsPlugin extends JavaPlugin {
    ...
    private void registerCommands() {
        ...
        Objects.requireNonNull(getCommand("skillset")).setExecutor(new SkillSetCommand(this));
        Objects.requireNonNull(getCommand("skillreset")).setExecutor(new SkillResetCommand(this));
        Objects.requireNonNull(getCommand("query")).setExecutor(new QueryCommand(this));
        Objects.requireNonNull(getCommand("sword")).setExecutor(new SwordCommand(this));
    }

    private void registerListeners() {
        getServer().getPluginManager().registerEvents(new SkillGainListener(this), this);
